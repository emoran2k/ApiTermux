    ...
    fs.readFile('index.html', 'utf8', function(err, html) {
      ...
      fs.writeFile('index.html', nuevoHtml, 'utf8', function(err) {
          ...
          //open('index.html')
            ...
            // });
            exec(`am start \ -a android.intent.action.MAIN \-c android.intent.category.LAUNCHER \ -n com.example.cashcore_sign/com.example.cashcore_sign.MainActivity`, (err, stdout, stderr) => {
                if (err) {
                console.error(`Error al abrir la URL: ${err}`);
                return;
                }
